...
class Ui_SwingMain(object):
    ...
    def retranslateUi(self, SwingMain):
        ...
        self.pushButtonSettings.setToolTip(QCoreApplication.translate("SwingMain", u"Open connection settings", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonSettings.setText(QCoreApplication.translate("SwingMain", u"Settings", None))
#if QT_CONFIG(tooltip)
        self.pushButtonConnect.setToolTip(QCoreApplication.translate("SwingMain", u"Connect or reconnect to Treehouse", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonConnect.setText(QCoreApplication.translate("SwingMain", u"Connect", None))
#if QT_CONFIG(tooltip)
        self.pushButtonPlayblast.setToolTip(QCoreApplication.translate("SwingMain", u"Open DCC Playblast", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonPlayblast.setText(QCoreApplication.translate("SwingMain", u"Playblast", None))
#if QT_CONFIG(tooltip)
        self.pushButtonExport.setToolTip(QCoreApplication.translate("SwingMain", u"Open DCC Export", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.pushButtonBreakout.setToolTip(QCoreApplication.translate("SwingMain", u"Open Shot Breakout", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonBreakout.setText(QCoreApplication.translate("SwingMain", u"Breakout", None))
#if QT_CONFIG(tooltip)
        self.pushButtonSearchFiles.setToolTip(QCoreApplication.translate("SwingMain", u"Search for files", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.radioButtonAsset.setToolTip(QCoreApplication.translate("SwingMain", u"Filter files by selected asset", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.toolButtonAssetInfo.setToolTip(QCoreApplication.translate("SwingMain", u"Open Asset Information", None))
#endif // QT_CONFIG(tooltip)
        self.toolButtonAssetInfo.setText(QCoreApplication.translate("SwingMain", u"...", None))
#if QT_CONFIG(tooltip)
        self.radioButtonShot.setToolTip(QCoreApplication.translate("SwingMain", u"Filter files by selected shot", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.toolButtonShotInfo.setToolTip(QCoreApplication.translate("SwingMain", u"Open Shot Information", None))
#endif // QT_CONFIG(tooltip)
        self.toolButtonShotInfo.setText(QCoreApplication.translate("SwingMain", u"...", None))
#if QT_CONFIG(tooltip)
        self.pushButtonNew.setToolTip(QCoreApplication.translate("SwingMain", u"Create a new scene", None))
#endif // QT_CONFIG(tooltip)
        self.pushButtonNew.setText(QCoreApplication.translate("SwingMain", u"New", None))
#if QT_CONFIG(tooltip)
        self.pushButtonPublish.setToolTip(QCoreApplication.translate("SwingMain", u"Publish current scene to Treehouse", None))
#endif // QT_CONFIG(tooltip)
