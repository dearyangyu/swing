...
class PlaylistEpisodeWorker(QtCore.QRunnable):

    mode = "Download"

    def __init__(self, parent, item, target, extract_zips = True, params = {}):
        super(PlaylistEpisodeWorker, self).__init__(self, parent)
        self.parent = parent
    ...
    def run(self):
        ...
        target = os.path.join(self.target, self.selected_file["entity"]["name"])
