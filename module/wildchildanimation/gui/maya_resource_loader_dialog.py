...
class Ui_MayaResourceLoaderDialog(object):
    ...
    def retranslateUi(self, MayaResourceLoaderDialog):
        ...
        self.rbOpenSource.setToolTip(fakestr(u"Use existing file as starting point for new scene. Will overwrite existing scene file", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.rbOpenSource.setStatusTip(fakestr(u"Open resource from location", None))
#endif // QT_CONFIG(statustip)
        self.rbOpenSource.setText(fakestr(u"Open as Template", None))
#if QT_CONFIG(shortcut)
        self.rbOpenSource.setShortcut(fakestr(u"Alt+O", None))
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.rbImportSource.setToolTip(fakestr(u"Import existing file into current scene", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.rbReferenceSource.setToolTip(fakestr(u"Reference existing file into current scene", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
