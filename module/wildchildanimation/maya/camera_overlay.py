### Camera Overlay Utilities
### Taken from '''https://pejaycee.wixsite.com/pjcvfxviewport-overlay
...
class Overlay_Function(object):
    ...
    def __init__(self):
        print("{}:{}".format(__class__.__name__, "__init__"))

        self.currentOverlay = ""

    #    Method for getting camera data
    def cameraQuery(self, **kwargs):
        print("{}:{} - {}".format(__class__.__name__, "cameraQuery", kwargs))
    ...
    def cameraProperties(self): ###Code from Chris Zurbrigg (http://zurbrigg.com), Shot Mask
        print("{}:{}".format(__class__.__name__, "cameraProperties"))
    ...
    def createThirdsGrid(self):
        print("{}:{}".format(__class__.__name__, "createThirdsGrid"))
        ...
        for line in self.lines:
            ...
            # clean_line = "_".join(line.split("|"))
            print("{}:{} '{}'".format(__class__.__name__, "createThirdsGrid", line))
    ...
    def createGoldenSpiral(self, position = "topRight"):
        print("{}:{}".format(__class__.__name__, "createThirdsGrid"))

        ###Technically it's the fibonacci spiral, but it makes little difference 
        self.cameraProperties()
    ...
    def toggleGoldenSpiral(self, position = "None"):
        print("{}:{}".format(__class__.__name__, "toggleGoldenSpiral"))
        ...
        try:
            ...
            try:
                ...
                pass
            if position == "None":
                self.createGoldenSpiral(position = "topRight")
            else:
                self.createGoldenSpiral(position)
        cmds.undoInfo(stateWithoutFlush = True)

    def toggleGoldenSpiralTopRight(self):
        self.toggleGoldenSpiral(position = "topRight")

    def toggleGoldenSpiralTopLeft(self):
        self.toggleGoldenSpiral(position = "topLeft")

    def toggleGoldenSpiralBottomRight(self):
        self.toggleGoldenSpiral(position = "bottomRight")

    def toggleGoldenSpiralBottomLeft(self):
        self.toggleGoldenSpiral(position = "bottomLeft")


    #    Method for Checking for existing Overlays
    def checkCurrentOverlay(self):
        print("{}:{}".format(__class__.__name__, "checkCurrentOverlay"))
    ...
    def active_camera(cls):
        print("{}:{}".format(__class__.__name__, "active_camera"))
