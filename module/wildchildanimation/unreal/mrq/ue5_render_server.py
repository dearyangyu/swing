...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------
class UE5RenderServer(QtCore.QObject):
                    ...
                    while True:
                        ...
                        try:
                            ...
                            if log == '' and proc.poll() != None:
                                ...
                                if SUPPRESS_LINES: 
                                    for item in UE5RenderServer.SUPPRESS_LINES:
                                        if item in log:
                                            suppress_count += 1
                                            show_line = False
                                            break
...
if __name__ == "__main__":
    write_log("UE5RenderServer::start")
    #server = UE5RenderServer(project_name = "Wind in the Willows")

    ##server = UE5RenderServer(project_name = "Attack of the Killer Bunny S1")
