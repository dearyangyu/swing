####################################
# use this script for Rigging tasks.
...
if __name__ == '__main__':
    if mc.objExists('*:guide_skip') or mc.objExists('guide_skip'):
        mc.confirmDialog(
            title='!!!!!PAY ATTENTION!!!!!',
        ...
        mc.confirmDialog(
            title="{} v{} - Rigging".format(SurfnTurf.__class__.__name__, SurfnTurf.VERSION),
